          ...
          <div>
            {searchResults.map((news) => {
              return (
                <div
                  key={news.objectID}
                  className="block mb-5 rounded-lg bg-white text-blue-700 text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700"
                >
